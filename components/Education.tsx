                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        ...
                        <div className="glass rounded-2xl p-8 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
                            ...
                            <h4 className="text-lg font-bold mb-1" style={{ fontFamily: "var(--font-space-grotesk)" }}>
                                B.Tech in Computer Science
                            </h4>
                            <p className="text-[#00ff87] font-semibold text-sm mb-1">XYZ University</p>
                            <p className="text-[rgba(232,232,240,0.45)] text-sm mb-5">Lahore, Pakistan</p>

                            <div className="space-y-2.5">
                                {[
                                    "Specialized in Mobile & Distributed Systems",
                                    "Final Year Project: AI-powered Android App",
                                    "CGPA: 3.7 / 4.0",
                                ].map((item) => (
